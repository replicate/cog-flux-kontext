...
def prepare_kontext(
    ...
    return_dict = prepare(t5, clip, img, prompt)
    return_dict["img_cond_seq"] = torch.cat(img_cond_seq, dim=1)
    return_dict["img_cond_seq_ids"] = torch.cat(img_cond_seq_ids, dim=1)
